...
function download_to_array( url, callback )
{
	...
	{
        console.log("download_legacy: " + url);
		window['processBase64Zcode'] = function( data )
		{
            console.log("make call to callback from download_legacy");
	...
	*/
	...
	if ( binary && page_domain == data_domain )
	{
		options = {
			...
			{
                console.log("make call to callback from page = local domain");
	...
	else
	{
		...
		if ( backup_url )
		{
            console.log("make call to callback for case 5");
		...
		options = {
			...
			success: function ( data )
			{
                console.log("make call to callback for case 6");
