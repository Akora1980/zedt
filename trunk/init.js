...
if(!window.localStorage.getItem("init")) {
    ...
    file.add_to_library("http://mirror.ifarchive.org/if-archive/games/zcode/curses.z5", b64_data);
    ...
    var story_data = file.text_to_array( xmlhttp.responseText );
    b64_data = file.base64_encode(story_data);
    file.add_to_library("http://mirror.ifarchive.org/if-archive/games/zcode/photopia.z5", b64_data);
